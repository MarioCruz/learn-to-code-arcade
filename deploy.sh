...
mpremote connect "$PORT" fs cp color_setup.py game_common.py menu.py nanogui_test.py touch_test.py tictactoe_test.py connect4_test.py minesweeper_test.py hangman_test.py 2048_test.py :
...
echo "  mpremote connect $PORT run 2048_test.py"
